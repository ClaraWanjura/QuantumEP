...
def initialize_phase_sensor_parameters(phase_sensor,use_optimizer=None):
  """
...
def prepare_cluster_Ising_phase_sensor(N_sys,N_sens,sys_operators=None):
  N=N_sys+N_sens
